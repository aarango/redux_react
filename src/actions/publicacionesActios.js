...
import { CARGANDO, ERROR, ACTUALIZAR, COM_CARGANDO, COM_ERROR, COM_ACTUALIZAR } from "../types/publicacionesType";
...
export const abrirCerrar = (pub_key, com_key) => (dispatch, getState) => {
  ...
  const actualizada = {
    ...seleccionada,
    abierto: !seleccionada.abierto // la propiedad abierto va aser lo contrario a la seleccion
  };
...
// con esta función busco los comentarios del api
